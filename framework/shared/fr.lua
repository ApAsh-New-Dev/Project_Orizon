Locales['fr'] = {
  ...
  -- Salary related
  ['received_salary'] = 'Salaire [~b~Civil~s~] : ~g~$%s',
  ['received_help']   = 'Salaire [~o~Crew~s~] : ~g~$%s',
  ...
  --crew
  ['command_setcrew'] = 'assigner une Crew à un joueur',
  ['command_setcrew_crew'] = 'nom de Crew',
  ['command_setcrew_grade'] = 'grade de Crew',
  ['command_setcrew_invalid'] = 'Crew le grade ou les deux sont invalides',
